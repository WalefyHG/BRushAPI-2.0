    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_image', models.ImageField(blank=True, default='', max_length=255, null=True, upload_to='image/')),
                ...
                ('user_banner', models.ImageField(blank=True, default='', max_length=255, null=True, upload_to='banner/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='usuarios.chatroom')),
            ],
        ),
        migrations.CreateModel(
            name='Notices',
            fields=[
                ...
                ('notice_image', models.ImageField(blank=True, max_length=255, null=True, upload_to='newsImage/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friendship_status', models.CharField(blank=True, choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('rejected', 'Rejected')], max_length=20, null=True)),
